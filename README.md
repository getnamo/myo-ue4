...
A [Thalmic Myo](https://www.thalmic.com/en/myo/) Plugin for Unreal Engine 4. Latest plugin is bound to beta 9, requires Myos to have [firmware 1.1.5](https://developer.thalmic.com/downloads) or later.
