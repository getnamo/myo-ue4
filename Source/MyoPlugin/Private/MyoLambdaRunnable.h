...
completion.
*/
class FMyoLambdaRunnable : public FRunnable
...
public:
	...
	FMyoLambdaRunnable(TFunction< void()> InFunction);
	virtual ~FMyoLambdaRunnable();
	...
	*/
	static FMyoLambdaRunnable* RunLambdaOnBackGroundThread(TFunction< void()> InFunction);
