...
completion.
*/
class MyoLambdaRunnable : public FRunnable
{
private:
...
public:
	...
	MyoLambdaRunnable(TFunction< void()> InFunction);
	virtual ~MyoLambdaRunnable();
	...
	*/
	static MyoLambdaRunnable* RunLambdaOnBackGroundThread(TFunction< void()> InFunction);
